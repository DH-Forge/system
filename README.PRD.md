...
- **URL Versioning (`X.Y.x` Format):** Registry URLs _must_ use a `Major.Minor.x` format (e.g., `https://api.dh-forge.com/1.2.x/registry-core.json`). This URL _always_ serves the _latest patch version_ within that minor release, allowing automatic non-breaking updates.
...
```json
// Example: https://api.dh-forge.com/1.2.x/registry-core.json (serving 1.2.9)
{
  "meta": {
...
```json
{
  "meta": {
    ...
    "extendsCore": "https://api.dh-forge.com/1.2.x/registry-core.json"
  },
